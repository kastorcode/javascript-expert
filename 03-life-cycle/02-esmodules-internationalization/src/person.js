export class Person {
  ...
  static generateInstanceFromString (input) {
    const [id, vehicles, kmTraveled, from, to] = input.split(' ')
    const person = new Person({ id, kmTraveled, from, to, vehicles:vehicles.split(',') })
    return person
  }
