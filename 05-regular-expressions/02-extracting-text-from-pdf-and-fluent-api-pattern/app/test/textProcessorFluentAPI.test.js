...
describe('TextProcessorFluentAPI Suite Test', () => {
  ...
  it('should return a TextProcessorFluentAPI instance', () => {
    const result = new TextProcessorFluentAPI('Hello World')
    expect(result).to.be.instanceOf(TextProcessorFluentAPI)
  })
